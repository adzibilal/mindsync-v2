  ...
  "group/button inline-flex shrink-0 items-center justify-center border border-transparent bg-clip-padding text-sm font-semibold whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        tertiary:
          "rounded-xl bg-card text-ink border border-ink hover:bg-muted active:bg-muted/80",
        outline:
          "rounded-xl bg-card text-ink border border-ink hover:bg-muted active:bg-muted/80",
        destructive:
      ...
      size: {
        default:
          "h-12 gap-2 px-6 py-3 text-[16px] font-semibold leading-6",
        sm: "h-10 gap-1.5 px-4 py-2.5 text-[14px] font-semibold leading-5",
        xs: "h-8 gap-1 rounded-[min(var(--radius-md),10px)] px-3 py-1.5 text-[12px] font-semibold leading-4 in-data-[slot=button-group]:rounded-lg has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3",
